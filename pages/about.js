              ...
              <div className="mt-8 lg:mt-0 leading-8 text-gray">
                <div className="max-w-prose mx-auto lg:max-w-none">
                  <p>
                    ...
                    investment advisory firm. Prior to this, I spent 15 years
                ...
                <div className="mt-5 prose prose-indigo mx-auto lg:max-w-none lg:row-start-1 lg:col-start-1 leading-8 text-gray">
                  <p>
                    I earned my Bachelor of Arts Degree in political science
                  ...
                  <p>
                    I live in Newport Beach with my wife Sandy, and sons Sean
                    and Jack. I am passionate about living a very active
                    lifestyle including gym workouts, beach runs, bike rides and
                    surfing.
                  </p>
                </div>
              </div>
