        ...
        <div className="lg:grid lg:grid-cols-12">
          ...
          <div className="relative bg-accent lg:col-start-3 lg:row-start-1 lg:col-span-10 lg:rounded-3xl lg:grid lg:grid-cols-10 lg:items-center">
            ...
            <div className="relative max-w-md mx-auto py-12 px-4 space-y-6 sm:max-w-3xl sm:py-16 sm:px-6 lg:max-w-none lg:p-0 lg:col-start-4 lg:col-span-6">
              ...
              <a
                className="block w-full py-3 px-5 text-center bg-gray-100 border border-transparent rounded-md shadow-md text-base font-medium text-dark hover:bg-gray-50 sm:inline-block sm:w-auto"
                href="#">
                View Services
              </a>
            </div>
